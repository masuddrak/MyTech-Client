...
const PaymentCart = ({ inputValue }) => {
  ...
  return (
    <div
      className={`border-[1px] border-black p-3 flex gap-2 items-center cursor-pointer my-3 ${
        activePayment && "border-red-700"
      } `}
      onClick={() => handelPayment(inputValue)}
    >
      <input
        type="radio"
        ...
        value={inputValue}
        id=""
        onChange={() => setActivePayment(activePayment)}
      />
      <div className="">
        <p>
